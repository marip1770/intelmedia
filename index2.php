			...
			<div class="container-xl">
				...
				<div class="collapse navbar-collapse">
					...
					<ul class="navbar-nav mr-auto">
						...
						<li class="nav-item">
							<a class="nav-link" href="index.html">Tenaga Kerja</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="index.html">Megapolitan</a>
						</li>
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" href="#">Lainnya</a>
							<ul class="dropdown-menu">
								<li><a class="dropdown-item" href="blog-single.html">Olahraga</a></li>
								<li><a class="dropdown-item" href="blog-single-alt.html">Hiburan</a></li>
								<li><a class="dropdown-item" href="about.html">TNI/POLRI</a></li>
								<li><a class="dropdown-item" href="contact.html">Hukum</a></li>
								<li><a class="dropdown-item" href="contact.html">Viral</a></li>
							</ul>
						</li>
					</ul>
				</div>
				...
				<div class="col-lg-8">
					...
					<div class="post featured-post-lg">
						<div class="details clearfix">
							<a href="category.html" class="category-badge">Tenaga Kerja</a>
							<h2 class="post-title"><a href="blog-single.html">Menaker Edukasi Permenaker No 4 Tahun 2023 Kepada CPMI Indramayu</a></h2>
							<ul class="meta list-inline mb-0">
								<li class="list-inline-item"><a href="#">Intelmedia News</a></li>
								<li class="list-inline-item">10 Okotober 2023</li>
							</ul>
						</div>
						<a href="blog-single.html">
							<div class="thumb rounded">
								<div class="inner data-bg-image" data-bg-image="images/posts/cntn1.jpeg"></div>
							</div>
						</a>
					</div>
		...
		<div class="container-xl">
			<div class="footer-inner">
				<div class="row d-flex align-items-center gy-4">
					<!-- copyright text -->
					<div class="col-md-4">
						<span class="copyright">© 2023 Intelmedia News.</span>
					</div>
...
<div class="canvas-menu d-flex align-items-end flex-column">
	...
	<nav>
		<ul class="vertical-menu">
			...
			<li><a href="category.html">Tenaga Kerja</a></li>
			<li><a href="category.html">Megapolitan</a></li>
			<li>
				<a href="#">Lainnya</a>
				<ul class="submenu">
					<li><a href="category.html">Olahraga</a></li>
					<li><a href="blog-single.html">Hiburan</a></li>
					<li><a href="blog-single-alt.html">TNI/POLRI</a></li>
					<li><a href="about.html">Hukum</a></li>
					<li><a href="contact.html">Viral</a></li>
				</ul>
	</nav>
