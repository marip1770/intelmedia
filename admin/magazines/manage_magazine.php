...
<div class="card card-outline card-primary rounded-0 shadow-sm my-3">
    <div class="card-header rounded-0">
        <h5 class="card-title"><?= isset($id) ? "Add New Magazine" : "Update Magazine Details" ?></h5>
    </div>
        ...
        <div class="container-fluid">
            <form action="" id="magazine-form">
                ...
                <div class="form-group">
                    <label for="title" class="control-label text-purple">Magazine Title/Name</label>
                    <input type="text" name="title" id="title" class="form-control form-control-border" placeholder="Magazine title" value ="<?php echo isset($title) ? $title : '' ?>" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group col-6">
					<label for="banner" class="control-label text-purple">Magazine Cover</label>
    ...
    <div class="card-footer rounded-0">
        <button class="btn btn-primary" type="submit" form="magazine-form">Save Magazine</button>
        <a class="btn btn-secondary" href="./?page=?magazines">Cancel</a>
    </div>
</div>
<script>
